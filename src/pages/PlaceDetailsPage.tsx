...
const PlaceDetailsPage = () => {
  ...
  return (
    <div className="mt-6 max-w-7xl grid grid-cols-4 gap-x-3">
      ...
      <div className="col-start-3 grid grid-cols-1 gap-y-3">
      ...
      <div className="col-start-4 grid grid-cols-1 gap-y-3">
